...
- **Keyless (Workload Identity / ADC).** No service-account key in the
  ...
  identity ([ADR 0035](../adr/0035-cloud-connector-auth-keyless-first.md)). Grant
...
- [google_cloud_platform.md](google_cloud_platform.md) — the generic GCP connection and full keyless background.
- [gcpbigquery.md](gcpbigquery.md) — the other GCP data service in this batch.
