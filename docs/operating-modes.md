...
trusted networks only); Pro is a near-term goal — the Helm chart is
installable + gated, but not blessed until the v0.1.0-alpha cut.
...
| | 🥈 **Lite** (`leoflow lite`) | 🥇 **Pro** *(coming soon)* | **Demo** (contributor) |
|---|---|---|---|
...
| HTTP / gRPC / metrics | **8088 / 9099 / 9098** (distinct, coexists with Demo) | per Helm values | 8080 / 9091 / 9090 |
