...
| Auth | JWT login (real) | **Real admin login** (single admin generated by `leoflow setup`; password recoverable via `leoflow lite reset-password`) | JWT + RBAC, TLS (#58), workload identity (#56) |
