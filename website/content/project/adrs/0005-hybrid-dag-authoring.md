...
aliases:
  - /adr/0005-hybrid-dag-authoring.html
# --- end AUTO redirect aliases ---
title: "ADR 0005: Hybrid DAG Authoring with Compile-Time Parsing"
linkTitle: 0005 · Hybrid DAG Authoring with Compile-Time Parsing
weight: 50
description: "ADR 0005: Hybrid DAG Authoring with Compile-Time Parsing"
---

**Status:** Accepted
**Refined by:** [ADR 0024](/project/adrs/0024-dag-parsing-structural-shim/) — the parser extracts the graph via a dependency-free structural shim of Airflow, not the official Airflow SDK.
**Date:** 2026-05-21
