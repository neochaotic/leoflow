...
aliases:
  - /adr/0029-lite-datastore-default-docker.html
# --- end AUTO redirect aliases ---
title: "ADR 0029: Lite Datastore Default — Docker Postgres (Managed PG is the Opt-In)"
linkTitle: 0029 · Lite Datastore Default — Docker Postgres (Managed PG is the Opt-In)
weight: 290
description: "ADR 0029: Lite Datastore Default — Docker Postgres (Managed PG is the Opt-In)"
---

**Status:** Superseded by [ADR 0030](/project/adrs/0030-lite-datastore-auto-select/)
**Date:** 2026-05-27
...
> [ADR 0030](/project/adrs/0030-lite-datastore-auto-select/).
